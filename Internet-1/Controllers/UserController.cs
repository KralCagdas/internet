...
namespace Internet_1.Controllers
{
    ...
    public class UserController : Controller
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Update(UserModel model, IFormFile PhotoFile)
        {
            ...
            if (PhotoFile != null && PhotoFile.Length > 0)
            {
                ...
                var filePath = Path.Combine("wwwroot/userPhotos", uniqueFileName);
                ...
                // Fotoğrafın yeni yolunu PhotoUrl'e ata
                user.PhotoUrl = "/userPhotos/" + uniqueFileName;
            }
